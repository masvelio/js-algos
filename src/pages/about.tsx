      ...
      <Main>
        <Stack spacing="12">
          ...
          <Text>
            ...
            site was created to firstly learn Next.js, and secondly to fulfill
            my goal of releasing my first product. Get to know me a little
            better{" "}
            <Link
          ...
          <Text>
            ...
            community had gathered. So I thought that I could give this project
            a breath of fresh air.
          </Text>
          <Text>
            This site uses the javascript-algorithms repository as a git
            submodule, which is pulled and parsed when the application is built
            so that the algorithms and data structures can be displayed as a
            list and dedicated subpages. Besides it uses{" "}
            <Link
